...
description: |
  Detecting Spatial-Temporal Patterns of Monthly Cumulative Confirmed Cases Rates and Death Rates in Jakarta DKI.
author:
  - name: Genice Goh
    url: {}
date: 09-10-2021
...
- In March 2020, the number of deaths range from 0 to 3, with hardly any distribution. It is therefore not wise to perform any statistical analysis and the cumulative death rates box plot will not be taken into account in the later analysis below.
