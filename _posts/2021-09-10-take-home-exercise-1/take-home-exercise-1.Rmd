...
- It can be observed that there are upper outliers in March 2020, with most of them located in the central region and only 1 along the north-western coast.
- The upper outliers are consistently located in the central region, across time.

### 6.1.2 Cumulative Death Rates By Month
```{r echo=TRUE, eval=TRUE}
tmap_arrange(boxmap("MENINGGAL_Apr20", jakartaDKI_rates),
...
rel_risk_map <- tm_shape(jakartaDKI_risk) +
  ...
  tm_layout(main.title = "RELATIVE_RISK",
              main.title.size = 0.5,
