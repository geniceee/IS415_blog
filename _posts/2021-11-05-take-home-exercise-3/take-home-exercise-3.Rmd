...
The result shows that the **recommended data point** is **57**. We will then pass this value in while computing the adaptive bandwidth GWR model. 
...
From our study, we found that the majority of these factors affect the resale prices of 4-room flats with a transaction period from 01-Jan-2019 to 30-Sep-2020. Only the factor **PROX_CBD** is not used in model building since it has high correlation with another factor **GD_PRISCH**.
